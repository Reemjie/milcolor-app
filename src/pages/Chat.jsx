    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100dvh - 130px)' }}>
      ...
      <div style={{ padding: '16px 16px 0', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <button onClick={() => navigate('/documents')} style={{ background: 'var(--bg)', border: '1.5px solid var(--border)', borderRadius: 10, padding: '7px 12px', fontWeight: 700, fontSize: '0.78rem', color: 'var(--text2)' }}>
            📁 Docs
          </button>
        </div>
