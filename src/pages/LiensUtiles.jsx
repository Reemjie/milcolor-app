...
const DEFAULTS = [
  { titre: "Besoins et intérêts de l'enfant", url: 'https://www.ressources-acm.fr/fiches-pratiques/besoins-et-interets-de-lenfant', description: "Comprendre les besoins fondamentaux", categorie: 'pedagogie' },
  { titre: 'Projets en animation', url: 'https://www.ressources-acm.fr/fiches-pratiques/projets-en-animation', description: 'Construire et mener des projets pédagogiques', categorie: 'pedagogie' },
  { titre: 'Types de séjours', url: 'https://www.ressources-acm.fr/fiches-pratiques/types-de-sejours', description: 'Les différents types de séjours en ACM', categorie: 'pedagogie' },
  { titre: "Rôles et fonctions", url: 'https://www.ressources-acm.fr/fiches-pratiques/roles-et-fonctions', description: "Les rôles de chacun dans l'équipe", categorie: 'pedagogie' },
  { titre: 'Organiser la vie quotidienne', url: 'https://www.ressources-acm.fr/conseils/organiser-la-vie-quotidienne', description: 'Conseils pratiques pour le quotidien', categorie: 'pedagogie' },
  { titre: 'Autorité, limites et sanctions', url: 'https://www.ressources-acm.fr/conseils/autorite-limites-et-sanctions', description: 'Gérer les comportements difficiles', categorie: 'pedagogie' },
  { titre: 'Accueillir un enfant avec handicap', url: 'https://www.ressources-acm.fr/conseils/accueillir-un-enfant-avec-handicap', description: "Adapter l'accueil", categorie: 'sante' },
  { titre: 'Encadrement et qualifications', url: 'https://www.ressources-acm.fr/reglementation/encadrement-et-qualifications', description: "Taux d'encadrement, diplômes requis", categorie: 'reglementation' },
  { titre: 'Transports et déplacements', url: 'https://www.ressources-acm.fr/reglementation/transports-et-deplacements', description: 'Règles pour les sorties', categorie: 'reglementation' },
  { titre: 'Activités physiques et sportives', url: 'https://www.ressources-acm.fr/reglementation/activites-physiques-et-sportives', description: 'Encadrement des APS en ACM', categorie: 'reglementation' },
  { titre: 'Santé et hygiène', url: 'https://www.ressources-acm.fr/reglementation/sante', description: 'Règles sanitaires, PAI', categorie: 'sante' },
  { titre: 'Ressources ACM', url: 'https://www.ressources-acm.fr', description: 'Site de référence pour les ACM', categorie: 'general' },
